          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-4">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-sm font-medium text-slate-900">Quick Stats</h3>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold text-blue-600">{stats.active}</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                {stats.dueToday > 0 && (
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-semibold text-yellow-600">{stats.dueToday}</span>
                  </div>
                )}
              </div>
            </div>
